    ...
    let display = (
      <div>
        <p style={{ background: "#eeeeee" }}>
          Product Address: {medicineAddress}
        </p>
        <p style={{ background: "#eeeeee" }}>Product Manufacturer: {data[0]}</p>
        <p style={{ background: "#eeeeee" }}>Description: {data[1]}</p>
        <p style={{ background: "#eeeeee" }}>
          Product Raw Materials: {data[2]}
        </p>
        <p style={{ background: "#eeeeee" }}>Product Quantity: {data[3]}</p>
        <p style={{ background: "#eeeeee" }}>Product Transporter: {data[4]}</p>
        <p style={{ background: "#eeeeee" }}>Product Wholesaler: {data[8]}</p>
        <p style={{ background: "#eeeeee" }}>Product Distributor: {data[5]}</p>
        <p style={{ background: "#eeeeee" }}>
