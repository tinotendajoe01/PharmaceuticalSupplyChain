    ...
    let display = (
      <div>
        <p style={{ background: "#eeeeee" }}>
          Generated Product ID: {rawMaterialAddress}
        </p>
        <p style={{ background: "#eeeeee" }}>Description: {data[1]}</p>
        <p style={{ background: "#eeeeee" }}>Product Quantity: {data[2]}</p>
        <p style={{ background: "#eeeeee" }}>Product Supplier: {data[3]}</p>
        <p style={{ background: "#eeeeee" }}>Product Transporter: {data[4]}</p>
        <p style={{ background: "#eeeeee" }}>Product Manufacturer: {data[5]}</p>
        <p style={{ background: "#eeeeee" }}>
