...
export default function MedicineInfo(props) {
  ...
  async function getMedicineData() {
    ...
    let display = (
      <div>
        <p style={{ background: "#eeeeee" }}>Drug Address: {medicineAddress}</p>
        <p style={{ background: "#eeeeee" }}>Drug Manufacturer: {data[0]}</p>
        <p style={{ background: "#eeeeee" }}>Description: {data[1]}</p>
        <p style={{ background: "#eeeeee" }}>Raw Materials: {data[2]}</p>
        <p style={{ background: "#eeeeee" }}>Drug Quantity: {data[3]}</p>
        <p style={{ background: "#eeeeee" }}>Drug Transporter: {data[4]}</p>
        <p style={{ background: "#eeeeee" }}>Drug Wholesaler: {data[8]}</p>
  ...
  if (loading) {
    ...
    return (
      <div>
        <h1>Manufactured Drug Details</h1>
        <p>{details}</p>
